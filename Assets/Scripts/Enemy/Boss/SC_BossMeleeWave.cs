...
{
    [Tooltip("çUåÇîªíËÇèoÇ∑Ç‹Ç≈ÇÃéûä‘"), SerializeField] private float attackDelay = 0.5f;
    [Tooltip("çUåÇStateÇèIóπÇµÇƒIdleÇ…ñﬂÇÈÇ‹Ç≈ÇÃéûä‘"), SerializeField] private float endDelay = 1.0f;
